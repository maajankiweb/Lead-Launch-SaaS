...
export function Phase1Scrape({
  ...
  const [input, setInput] = useState<{ niche: string; city: string; count: number | string }>({
    niche: "",
    city: "",
    count: "",
  });
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-[10px] uppercase font-bold text-primary border-primary/30">
                {planConfig.name} ({planConfig.limits.maxLeadsPerScrape} Max)
              </Badge>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. Dentist, Salon, Cafe, Roofing"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. Austin, Mumbai, Miami, London"
                className="h-10 text-base"
              />
            </div>
            <div className="space-y-2">
            ...
            <Button
              onClick={runScrape}
              disabled={loading || !input.niche.trim() || !input.city.trim()}
          ...
          {leads.length > 0 && (
            <Button
              ...
              onClick={() => {
                ...
                link.setAttribute("download", `leads-${(input.city || "export").toLowerCase().replace(/[^a-z0-9]/g, "-")}.csv`);
